...
function Loginmain(){
  ...
  <div id="forms23-block">
    <div className="wrapper">
      <div className="logo1">
        <Link id="link" className="brand-logo" to="/index"><span>Renting</span>Properties</Link>
        {/* if logo is image enable this   
                  <Link id="link" class="brand-logo" to="/#index">
      ...
      <div className="d-grid forms23-grids">
        <div className="form23">
          ...
          <p>Not a member yet? <Link id="link" to="/signup">Register now</Link></p>
        </div>
