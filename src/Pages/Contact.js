      ...
      <div className="top-map row">
        ...
        <div className="cont-details col-md-4 pl-md-5 mt-md-0 mt-5">
          ...
          <div className="cont-top">
            ...
            <div className="cont-right">
              <h6>Email Us</h6>
              <p><a href="https://p.w3layouts.com/cdn-cgi/l/email-protection#204558414d504c450d4d41494c60535550504f52540e434f4d" className="mail"><span className="__cf_email__" data-cfemail="2d48554c405d414800404c44416d5e585d5d425f59034e4240">[email&nbsp;protected]</span></a></p>
            </div>
          </div>
        </div>
      </div>
